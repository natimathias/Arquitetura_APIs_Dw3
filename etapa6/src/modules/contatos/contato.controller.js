export class ContatoController {
  ...
  async getContatoByEmail(request, reply) {
    ...
    const contato = await this.contatoService.getContatoByEmail(email);
  ...
  async createContato(request, reply) {
    const novoContato = await this.contatoService.createContato(request.body);
  ...
  async updateContato(request, reply) {
    const { id } = request.params;
    const contatoAtualizado = await this.contatoService.updateContato(id, request.body);
